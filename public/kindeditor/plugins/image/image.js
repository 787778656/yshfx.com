...
KindEditor.plugin('image', function(K) {
	...
	self.plugin.imageDialog = function(options) {
		...
		var html = [
			...
			//水印开始
			'<div class="ke-dialog-row">',
			'<label style="width:60px;">图片水印</label>',
			'<select name="water">',
			...
			afterUpload : function(data) {	
				...
				if (data.error === 0) {
					...
					if (!fillDescAfterUploadImage) {
						...
						clickFn.call(self, url, data.img.title, data.img.width,data.img.height,data.img.border,data.img.align);
					} else {
